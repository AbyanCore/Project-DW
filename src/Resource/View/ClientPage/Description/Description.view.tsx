    ...
    return (
        <div className="w-full h-full bg-black py-10">
            <div className="w-full h-full flex justify-evenly items-center flex-col">
                <div className="relative w-full h-full flex md:flex-row flex-col items-center">
                    <span className="absolute md:w-1/2 flex-1 w-full h-2/3 md:rounded-r-3xl z-[2] md:to-transparent md:from-transparent bg-gradient-to-b from-black via-transparent to-black pointer-events-none" />
